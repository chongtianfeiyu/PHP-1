...
$title = '夕虚空间探针';
$blog = '夕虚小站';
$blogurl = 'http://xixuxz.cn';
$version = "V0.1 Beta"; //版本号
...
<!-- Powered by: Tomas(zntec.cn) -->
<style type="text/css">
<!--
* {font-family: "Microsoft Yahei",Tahoma, Arial; }
body{text-align: center; margin: 0 auto; padding: 0; background-color:#fff;font-size:12px;font-family:Tahoma, Arial}
...
th{padding: 3px 6px;font-weight:bold;background:#f9f9f9;color:#666;border:1px solid #ddd; text-align:left;height:20px;border-top:2px solid #66DBFF;}
tr{padding: 0; background:#fff;color:#777;}
td{padding: 3px 6px; border:1px solid #ddd;}
.w_logo{height:25px;text-align:center;color:#333;FONT-SIZE: 15px; width:13%; }
.w_top{background:#fff;height:30px;text-align:center; width:8.7%;}
.w_top:hover{background:#f9f9f9;font-size:15px;border-top:2px solid #FFCC00;}
.w_foot{height:25px;text-align:center; background:#fff;}
input{
...
.bar {border:1px solid #999999; background:#fff; height:5px; font-size:2px; width:89%; margin:2px 0 5px 0;padding:1px; overflow: hidden;}
.bar_1 {border:1px dotted #999999; background:#fff; height:5px; font-size:2px; width:89%; margin:2px 0 5px 0;padding:1px; overflow: hidden;}
...
<div class="logo"><a href="http://xixuxz.com" titla="<?php echo $title;?>"><img src="http://jhxw.qiniudn.com/3232427.png" alt="夕虚小站"><a></div>
...
<table>
  ...
  <tr>
    <td>CPU使用状况</td>
    <td colspan="5"><?php if('/'==DIRECTORY_SEPARATOR){echo $cpu_show;}?>
	</td>
  </tr>
  <tr>
    <td>硬盘使用状况</td>
...
<table>
  ...
  <table align="center" width="550" border="0" cellspacing="0" cellpadding="0" style="box-shadow: none;">
    <tr>
   ...
   <tr>
    <td colspan="11" class="suduk" ><table align="center" width="550" border="0" cellspacing="0" cellpadding="0" height="8" class="suduk" style="box-shadow: none;">
    <tr>
...
<table>
  ...
  ?>
	...
	<table>
		<tr>
			<td class="w_foot"><A HREF="<?php echo $blogurl;?>" target="_blank"><?php echo $blog;?></A></td>
			<td class="w_foot"><?php $run_time = sprintf('%0.4f', microtime_float() - $time_start);?>此次操作耗时 <?php echo $run_time?> 秒，约占用 <?php echo memory_usage();?> 内存！</td>
